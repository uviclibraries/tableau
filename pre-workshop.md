...
- Download and Install [Tableau for Students](https://www.tableau.com/academic/students){:target="_blank"} (10 min)<br>
  _*Please note that downloading this application requires your email address to be shared with Tableau servers located outside Canada. B.C. privacy legislation requires we inform you of this and obtain your consent to this arrangement. Participation in this workshop will be considered as your consent._
    - Click on "**Get Tableau for Free**" upon visiting the Tableau for Students link <img src="images\tableau-student.png" alt="tableau student sign up" style="width:250px;float:right;">
    - Fill out the form with your information using your UVic email address and then click "**Download the App**"
    - If the download does not begin, a small dialog box will appear with links to download again
      <img src="images\tableau-download.png" alt="download retry" style="width:400px;">
...
- OPTIONAL: [Introduction to Tableau](https://www.youtube.com/watch?v=jEgVto5QME8){:target="_blank"} video (20 min)<br>
