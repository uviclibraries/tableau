...
<div id="gif5">
   ...
   - Click the **Show Me** icon <img src="images\activity-2\show-me.png" alt="show me icon" style="width:60px;"> (top-right) and select the **Bar line chart** (3rd up from the bottom right). Click again on the **Show Me** icon again to close it
...
Above, you saw how to create different types of graphs. Now we are going to create charts that we will later put together into a single interactive dashboard.
   ...
   -   **Profit by Year Graph**
       ...
       <img src="images\activity-2\another-icon-menu.png" alt="filter menu" style="float:right;width:300px;">
        ...
        7.  The last step is to click on **Show Me** icon <img src="images\activity-2\show-me.png" alt="show me icon" style="width:60px;"> in the top-right corner and select the **Side-by-Side Bar Chart** option. After that, right-click on the name of your table at the bottom of the pane and rename it **Profit by Year**
