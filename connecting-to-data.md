...
2.  **Getting Started With Data**
    - In Connections Pane (left), click **Microsoft Excel**. Open the **Global_Superstore_Orders_2016.xlsx** file you downloaded to your computer or, if you haven't already, [download it now](resources/Global_Superstore_Orders_2016.xslx){:target="_blank"}
